            ...
            <div className="card  w-75 mx-auto  form-style container-fluid registration-style m-5 shadow-lg">
                <div className="row g-0 d-flex align-items-center  my-auto">
                    <div className="col-md-6 mx-auto">
                        <div className="card-body  info-style  border-1 rounded-3 container-fluid">
                            <div className="mx-5 text-center">
                                ...
                                <p><i class="fas fa-phone-square-alt"></i> Mobile: +88018842-85896</p>
                                <p><i class="fab fa-linkedin"></i> LinkedIn: <a className="" target="blank" href="https://www.linkedin.com/in/mohammad-nazmul-hasan-palash-b74292194">Mohammad_Nazmul_Hasan</a></p>
                    ...
                    <div className="col-md-5 ">
                        <form className="text-center mx-auto w-100 text-center  border-3 border-white rounded-3" action="mailto:antynion1998@gmail.com" method="post" enctype="text/plain">
